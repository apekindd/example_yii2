        ...
        <div class="form">
            ...
            <form name="name" id="myForm" action="/esputnik/send">
                ...
                <div class="form__container">
                    ...
                    <div class="form__input-container">
                        <label for="" class="form__label"><?= Yii::t('app', 'choose_course');?>
                        </label>
                        <select id="select1" class="form__select" name="<?= ES_TYPE ?>" required>
                            ...
                            <? foreach ($arr['courses'] as $course) :?>
                                <option value="<?=$this->getGroupsId("c", $course->id, "deti") ?>"><?=$course->title?></option>
                            <? endforeach;?>
                        </select>
                    </div>
                    <div class="form__input-container">
                    ...
                    <input type="hidden" name="<?= ES_TITLE ?>" value="Запись на курс для детей">
